...
namespace Contacts {
    ...
    public partial class ContactDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PeopleRow AddPeopleRow(string FirstName, string LastName, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall) {
...
namespace Contacts.ContactDBDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [People] ([FirstName], [LastName], [Company], [Telephone], [Email], [" +
                "Client], [LastCall]) VALUES (@FirstName, @LastName, @Company, @Telephone, @Email" +
                ", @Client, @LastCall)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [People] SET [FirstName] = @FirstName, [LastName] = @LastName, [Company] =" +
                " @Company, [Telephone] = @Telephone, [Email] = @Email, [Client] = @Client, [Last" +
                "Call] = @LastCall WHERE (([ContactID] = @Original_ContactID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [ContactID], [FirstName], [LastName], [Company], [Telephone], [Email], [Cl" +
                "ient], [LastCall] FROM [People]";
        ...
        public virtual int Insert(string FirstName, string LastName, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Company, string Telephone, string Email, bool Client, System.DateTime LastCall, int Original_ContactID) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
